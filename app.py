...
def inject_css():
    ...
    /* ---------- GLOBAL TEXT COLOR ----------
       Streamlit's default text is near-black, meant for a light theme.
       Our background is dark navy, so without this every unstyled
       label/heading/paragraph is invisible (black-on-black). */
    ...
    /* Keep code blocks / dataframe cells legible on their own light chips */
    .stApp code{
